/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_proximity_sensor.cpp>
 *
 * @author Carlo Pinciroli <ilpincy@gmail.com>
 */

#include "ci_lootbot_proximity_sensor.h"
...
namespace argos {
   ...
   CCI_LootBotProximitySensor::CCI_LootBotProximitySensor() :
      m_tReadings(24) {
   ...
   const CCI_LootBotProximitySensor::TReadings& CCI_LootBotProximitySensor::GetReadings() const {
     return m_tReadings;
   }
...
#ifdef ARGOS_WITH_LUA
   void CCI_LootBotProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_LootBotProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_LootBotProximitySensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_LootBotProximitySensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
