/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_distance_scanner_actuator.h>
 *
...
#ifndef CCI_LOOTBOT_DISTANCE_SCANNER_ACTUATOR_H
#define CCI_LOOTBOT_DISTANCE_SCANNER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LootBotDistanceScannerActuator;
};
...
namespace argos {
   ...
   class CCI_LootBotDistanceScannerActuator: virtual public CCI_Actuator {
   ...
   public:
        ...
        * Destructor.
        */
      virtual ~CCI_LootBotDistanceScannerActuator() {}
