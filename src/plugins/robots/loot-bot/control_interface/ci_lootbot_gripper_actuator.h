/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_gripper_actuator.h>
 *
...
#ifndef CCI_LOOTBOT_GRIPPER_ACTUATOR_H
#define CCI_LOOTBOT_GRIPPER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LootBotGripperActuator;
}
...
namespace argos {
   ...
   class CCI_LootBotGripperActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Class constructor.
       */
      CCI_LootBotGripperActuator();

      /**
       * Class destructor.
       */
      virtual ~CCI_LootBotGripperActuator() {}
