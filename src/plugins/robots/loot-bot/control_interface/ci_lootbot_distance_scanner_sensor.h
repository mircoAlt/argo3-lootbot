/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_distance_scanner_sensor.h>
 *
...
#ifndef CCI_LOOTBOT_DISTANCE_SCANNER_SENSOR_H
#define CCI_LOOTBOT_DISTANCE_SCANNER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LootBotDistanceScannerSensor;
}
...
namespace argos {
   ...
   class CCI_LootBotDistanceScannerSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_LootBotDistanceScannerSensor() :
         m_tReadings(4){
      }
       ...
       * Destructor
       */
      virtual ~CCI_LootBotDistanceScannerSensor() {}
