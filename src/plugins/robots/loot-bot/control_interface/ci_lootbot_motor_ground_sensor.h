/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_motor_ground_sensor.h>
 *
 * @brief This file provides the interface of the lootbot motor ground sensor.
 *
...
#ifndef CCI_LOOTBOT_MOTOR_GROUND_SENSOR_H
#define CCI_LOOTBOT_MOTOR_GROUND_SENSOR_H

namespace argos {
   class CCI_LootBotMotorGroundSensor;
}
...
namespace argos {
   ...
   public:
      ...
      CCI_LootBotMotorGroundSensor();

      virtual ~CCI_LootBotMotorGroundSensor() {}
   ...
   std::ostream& operator<<(std::ostream& c_os, const CCI_LootBotMotorGroundSensor::SReading& s_reading);
   std::ostream& operator<<(std::ostream& c_os, const CCI_LootBotMotorGroundSensor::TReadings& t_readings);
