/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_base_ground_sensor.h>
 *
 * @brief This file provides the interface of the lootbot base ground sensor.
 *
...
#ifndef CCI_LOOTBOT_BASE_GROUND_SENSOR_H
#define CCI_LOOTBOT_BASE_GROUND_SENSOR_H

namespace argos {
   class CCI_LootBotBaseGroundSensor;
}
...
namespace argos {
   ...
   class CCI_LootBotBaseGroundSensor : virtual public CCI_Sensor {
   ...
   public:
      ...
      CCI_LootBotBaseGroundSensor();

      virtual ~CCI_LootBotBaseGroundSensor() {}
