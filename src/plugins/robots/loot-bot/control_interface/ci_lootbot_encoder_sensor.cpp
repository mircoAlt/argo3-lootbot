/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_encoder_sensor.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "ci_lootbot_encoder_sensor.h"
...
namespace argos {
  ...
  const CCI_LootBotEncoderSensor::SReading& CCI_LootBotEncoderSensor::GetReading() const {
    return m_sReading;
  }
...
#ifdef ARGOS_WITH_LUA
  void CCI_LootBotEncoderSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
  void CCI_LootBotEncoderSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
