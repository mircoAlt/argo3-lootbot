...
/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_motor_ground_sensor.cpp>
 *
 * @author Carlo Pinciroli <ilpincy@gmail.com>
 */

#include "ci_lootbot_motor_ground_sensor.h"
...
namespace argos {
   ...
   CCI_LootBotMotorGroundSensor::CCI_LootBotMotorGroundSensor() :
      m_tReadings(4) {
   ...
   const CCI_LootBotMotorGroundSensor::TReadings& CCI_LootBotMotorGroundSensor::GetReadings() const {
     return m_tReadings;
   }
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_LootBotMotorGroundSensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_LootBotMotorGroundSensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_LootBotMotorGroundSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_LootBotMotorGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
