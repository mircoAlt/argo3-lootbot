/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_encoder_sensor.h>
 *
 * @brief This file provides the definition of the lootbot encoder sensor. It

 * This file provides the definition of the lootbot encoder sensor. It
 ...
 * On the lootbot there is a sensor that, at start-up, measure this distance,
...
#ifndef CCI_LOOTBOT_ENCODER_SENSOR_H
#define CCI_LOOTBOT_ENCODER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_LootBotEncoderSensor;
}
...
namespace argos {
   ...
   class CCI_LootBotEncoderSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Destructor
       */
      virtual ~CCI_LootBotEncoderSensor() {}
