/**
 * @file <argos3/plugins/robots/loot-bot/control_interface/ci_lootbot_turret_actuator.h>
 *
...
#ifndef CCI_LOOTBOT_TURRET_ACTUATOR_H
#define CCI_LOOTBOT_TURRET_ACTUATOR_H

namespace argos {
   class CCI_LootBotTurretActuator;
}
...
namespace argos {
   ...
   class CCI_LootBotTurretActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Destructor.
       */
      virtual ~CCI_LootBotTurretActuator() {}
       ...
       * @param un_mode turret control mode, possible values are defined in CCI_LootBotTurretActuator
       */
