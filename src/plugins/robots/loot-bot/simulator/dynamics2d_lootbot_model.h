/**
 * @file "../simulator/dynamics2d_lootbot_model.h"
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef DYNAMICS2D_LOOTBOT_MODEL_H
#define DYNAMICS2D_LOOTBOT_MODEL_H
...
namespace argos {
   ...
   class CDynamics2DLootBotModel : public CDynamics2DMultiBodyObjectModel {

   public:

      CDynamics2DLootBotModel(CDynamics2DEngine& c_engine,
                              CLootBotEntity& c_entity);
      virtual ~CDynamics2DLootBotModel();
