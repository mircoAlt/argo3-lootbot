/**
 * @file "../simulator/lootbot_entity.cpp"
 *
...
namespace argos {
   ...
   CLootBotEntity::CLootBotEntity(const std::string& str_id,
      ...
      try {
         ...
         m_pcDistanceScannerEquippedEntity =
            new CLootBotDistanceScannerEquippedEntity(this, "distance_scanner_0");
         ...
         m_pcTurretEntity = new CLootBotTurretEntity(this, "turret_0", cTurretAnchor);
   ...
   void CLootBotEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CLootBotEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CLootBotEntity,
                   "loot-bot",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The loot-bot robot, developed in the Swarmanoid project.",
                   "The loot-bot is a wheeled robot developed in the Swarmanoid Project. It is a\n"
                   ...
                   "loot-bot in the arena. When the robot is untranslated and unrotated, the\n"
                   ...
                   "The 'body/orientation' attribute specifies the orientation of the loot-bot. All\n"
                   ...
                   "loot-bot. The value of the attribute must be set to the id of a previously\n"
                   "defined controller. Controllers are defined in the <controllers> XML subtree.\n\n"
                   "OPTIONAL XML CONFIGURATION\n\n"
                   "You can set the emission range of the range-and-bearing system. By default, a\n"
                   "message sent by a loot-bot can be received up to 3m. By using the 'rab_range'\n"
                   "attribute, you can change it to, i.e., 4m as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <loot-bot id=\"fb0\" rab_range=\"4\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </loot-bot>\n"
                   "    ...\n"
                   ...
                   "system. By default, a message sent by a loot-bot is 10 bytes long. By using the\n"
                   "'rab_data_size' attribute, you can change it to, i.e., 20 bytes as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <loot-bot id=\"fb0\" rab_data_size=\"20\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </loot-bot>\n"
                   "    ...\n"
                   ...
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <loot-bot id=\"fb0\" omnidirectional_camera_aperture=\"80\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,0,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </loot-bot>\n"
                   "    ...\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CLootBotEntity);
