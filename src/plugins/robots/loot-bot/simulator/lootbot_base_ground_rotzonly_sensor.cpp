/**
 * @file "../simulator/lootbot_base_ground_rotzonly_sensor.cpp"
 *
...
#include "lootbot_base_ground_rotzonly_sensor.h"
...
namespace argos {
   ...
   CLootBotBaseGroundRotZOnlySensor::CLootBotBaseGroundRotZOnlySensor() :
   ...
   void CLootBotBaseGroundRotZOnlySensor::SetRobot(CComposableEntity& c_entity) {
   ...
   void CLootBotBaseGroundRotZOnlySensor::Init(TConfigurationNode& t_tree) {
      try {
         CCI_LootBotBaseGroundSensor::Init(t_tree);
         /* Parse noise level */
   ...
   void CLootBotBaseGroundRotZOnlySensor::Update() {
      /*
   ...
   void CLootBotBaseGroundRotZOnlySensor::Reset() {
   ...
   REGISTER_SENSOR(CLootBotBaseGroundRotZOnlySensor,
                   "lootbot_base_ground", "rot_z_only",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The loot-bot base ground sensor.",
                   "This sensor accesses the loot-bot base ground sensor. For a complete description\n"
                   "of its usage, refer to the ci_lootbot_base_ground_sensor.h interface. For the XML\n"
